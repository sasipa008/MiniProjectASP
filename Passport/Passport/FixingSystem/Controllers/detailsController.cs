...
namespace FixingSystem.Controllers
{
    public class detailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Building,Floor,Room,Details")] detail detail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Building,Floor,Room,Details")] detail detail)
        {
            if (ModelState.IsValid)
            {
